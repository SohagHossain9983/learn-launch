...
// console.log(sohag)
// console.log(sohag.length)
// console.log(sohag.search('h'))
// console.log(sohag.charCodeAt(1))
// console.log(sohag.at(5))
// console.log(sohag.slice(6))
// console.log(sohag.substring(4, 7))
